...
(function($) {
    $.fn.keyboard = function(options) {
        ...
        $(document).off('touchestar mousedown', '.jqbtk-row .btn');
        $(document).on('touchestar mousedown', '.jqbtk-row .btn', function(e) {
            //e.preventDefault();
        ...
        $(document).on('touchestar mousedown', '.jqbtk-row', function(e) {
            e.preventDefault();
            var parent = $('[aria-describedby=' + $(this).closest('.popover').attr('id') + ']');
            parent.focus();
        });
